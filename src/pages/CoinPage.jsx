...
const CoinPage = () => {
  ...
  return (
    <div className='rounded-div my-12 py-8'>
      ...
      <div className='grid md:grid-cols-2 gap-8'>
        ...
        <div>
          ...
          <div className='flex justify-around p-8 text-accent'>
            ...
            <FaFacebook className='cursor-pointer hover:scale-150 ease-in-out duration-300' />
            <FaReddit className='cursor-pointer hover:scale-150 ease-in-out duration-300' />
      ...
      {/* Description */}
      <div className='py-4'>
        <p className='text-xl font-bold pb-3'>About {coin.name}</p>
        <p
